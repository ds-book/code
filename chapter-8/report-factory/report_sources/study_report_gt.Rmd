...
diag_table_gt <- diag_table %>% gt(groupname_col = "diagnosis", row_group_as_column = TRUE) %>% 
  ...
  tab_header(title = "Типы диагнозов", subtitle = paste("Для группы возраста ", age_group)) %>%
