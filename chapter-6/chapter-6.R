...
# Создание таблицы с числовыми значениями количества дней восстановления для 20 пациентов возрастной группы “после 60 лет”, минимальное значение 75 дней, максимальное 125. 
value2 <- data.frame(day = sample(75:125, 20), group = "aged over 60")
